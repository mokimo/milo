...
import { toFragment, getFedsPlaceholderConfig, trigger, closeAllDropdowns, withLanaLog } from '../../utilities/utilities.js';
...
class ProfileDropdown {
  constructor({
    ...
    withLanaLog(this.init.bind(this), 'ProfileDropdown.init()');
  }
