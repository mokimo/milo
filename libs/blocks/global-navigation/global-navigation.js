  ...
  decorateProfileMenu = ({ avatarImg, sections, profileRes, profileButton }) => {
    ...
    const decorate = async (event) => {
      ...
      this.blocks.profile.instance = new this.Profile({
        accountLink: blockEl.querySelector('div > div > p:nth-child(2) a'),
        manageTeams: blockEl.querySelector('div > div > p:nth-child(3) a'),
        manageEnterprise: blockEl.querySelector('div > div > p:nth-child(4) a'),
