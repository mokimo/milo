...
export function getVideoAttrs(hash, dataset) {
  ...
  const poster = dataset?.videoPoster ? `poster='${dataset.videoPoster}'` : "poster='https://milo.adobe.com/drafts/osahin/media_138027a0a639b8b97c183fb1ea973e0d5f22b4841.png?width=2000&format=webply&optimize=medium'";
